...
class TestCMSSearchForm(FormTestCase):
    ...
    def test_pager_url(self):
        ...
        self.assertEqual(form._form_get_url_for_pager(render_values), "/foo")
        ...
        with mock.patch.object(
            ...
            self.assertEqual(
                form._form_get_url_for_pager({}), "/cms/search/res.partner"
            )
    ...
    # FIXME: this test is wrong as the widget should accept only integers
